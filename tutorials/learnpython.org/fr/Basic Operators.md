...
L'utilisation de deux symboles de multiplication établit une relation de puissance.
...
Python prend en charge la concaténation de chaînes en utilisant l'opérateur addition :
...
Les listes peuvent être jointes avec l'opérateur addition :
...
Le but de cet exercice est de créer deux listes appelées `x_list` et `y_list`,
