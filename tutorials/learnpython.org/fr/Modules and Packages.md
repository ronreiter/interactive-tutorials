...
Vous pouvez utiliser la commande `import *` pour importer tous les objets d'un module comme suit :
...
Pour importer le module `urllib`, qui nous permet de lire des données à partir d'URL, nous `importons` le module :
